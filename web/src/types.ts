...
export type Settings = { defaultProjectUrl:string; projectUrlsByStep:Record<StepKey,string>; projectNamesByStep:Record<StepKey,string>; runner:{ headless:boolean; timeoutMs:number; stopOnError:boolean; sendMode:'twoStep'; newChatPerStep:boolean } };
